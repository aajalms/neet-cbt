// questions.js  (Paste this file in your GitHub project)
// Format: { id, question, options[], answerIndex, correctAnswerText }
...
image: "images/IMG_9844.jpg",
  ...
  },
  {
    ...
    options: [
      "Mandatory",
      "Not required",
      "Required only if >18 years",
      "Required only if female",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Doctor must certify patient is compos mentis",
  ...
  },
  {
    ...
    options: [
      "Bartholin gland",
      "Skene glands",
      "Glands of labia minora",
      "Glands of labia majora",
    ],
    answerIndex: 2,
  ...
  },
  {
    ...
    options: [
      "Homicidal drowning",
      "Suicidal drowning",
      "Can be either homicidal or suicidal",
      "Accidental drowning",
    ],
    answerIndex: 2,
